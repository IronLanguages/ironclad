...
# these really should be autogenerated;
# nonetheless, this hand-rolled data should 
# eventually be useful for testing autogenerated 
# output
api_functions = (
    ...
    ('PyDict_New', 'ptr_void'),
    ('PyDict_Next', 'ptr_ptrsizeptrptrlong'),
