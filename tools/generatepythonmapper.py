...
def writefile(name, text):
    f = open(name, "w")
    try:
        f.write("/* This file was generated by tools/generatepythonmapper.py */")
...
def run(in_dir, out_dir):
    def mung_filename(name):
        return os.path.join(in_dir, name), os.path.join(out_dir, "PythonMapper_%s.Generated.cs" % name)
