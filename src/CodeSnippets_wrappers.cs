...
def _ironclad_new(cls, *args, **kwargs):
    return cls._dispatcher.construct('{0}.tp_new', cls, *args, **kwargs)
    
def _ironclad_init(self, *args, **kwargs):
    self._dispatcher.init('{0}.tp_init', self, *args, **kwargs)

def _ironclad_del(self):
    self._dispatcher.delete(self)

_ironclad_class_attrs['__new__'] = _ironclad_new
_ironclad_class_attrs['__init__'] = _ironclad_init
_ironclad_class_attrs['__del__'] = _ironclad_del
...
def _ironclad_getitem(self, key):
...
_ironclad_class_attrs['__getitem__'] = _ironclad_getitem
";

        public const string SETITEM_CODE = @"
def _ironclad_setitem(self, key, item):
...
_ironclad_class_attrs['__setitem__'] = _ironclad_setitem
";

        public const string LEN_CODE = @"
def _ironclad_len(self):
...
_ironclad_class_attrs['__len__'] = _ironclad_len
";

        public const string COMPLEX_HACK_CODE = @"
def _ironclad_complex(self):
    return complex(float(self.real), float(self.imag))
_ironclad_class_attrs['__complex__'] = _ironclad_complex
";

        public const string ITER_METHOD_CODE = @"
def _ironclad_iter(self):
    return self._dispatcher.method_selfarg('{0}tp_iter', self)
_ironclad_class_attrs['__iter__'] = _ironclad_iter
";

        public const string ITERNEXT_METHOD_CODE = @"
def _ironclad_raise_stop(self, resultPtr):
    if resultPtr == IntPtr(0) and self._dispatcher.mapper.LastException == None:
        raise StopIteration()

_ironclad_class_attrs['__raise_stop'] = _ironclad_raise_stop

def _ironclad_next(self):
    return self._dispatcher.method_selfarg('{0}tp_iternext', self, self.__raise_stop)

_ironclad_class_attrs['next'] = _ironclad_next
";

        public const string NOARGS_METHOD_CODE = @"
def _ironclad_method(self):
    '''{1}'''
    return self._dispatcher.method_noargs('{2}{0}', self)

_ironclad_class_attrs['{0}'] = _ironclad_method
";

        public const string OBJARG_METHOD_CODE = @"
def _ironclad_method(self, arg):
    '''{1}'''
...
def _ironclad_method(self, *args):
    '''{1}'''
...
def _ironclad_method(self, *args, **kwargs):
    '''{1}'''
...
def _ironclad_method(self, ssize):
    '''{1}'''
...
def _ironclad_method(self, ssize, obj):
    '''{1}'''
...
def _ironclad_method(self, ssize1, ssize2):
    '''{1}'''
...
def _ironclad_method(self, ssize1, ssize2, obj):
    '''{1}'''
...
def _ironclad_method(self, arg1, arg2):
    '''{1}'''
...
def _ironclad_method(self, arg1, arg2=None):
    '''{1}'''
...
def _ironclad_method(self, other):
    '''{1}'''
