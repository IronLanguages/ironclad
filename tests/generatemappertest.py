...
class GeneratePythonMapperTest(TestCase):
    ...
    def testCreatesPythonMapperComponents(self):
        ...
        try:
            ...
            self.assertEquals(read("PythonMapper_exceptions.Generated.cs"), EXPECTED_EXCEPTIONS)
            self.assertEquals(read("PythonMapper_store_dispatch.Generated.cs"), EXPECTED_STORE)
            self.assertEquals(read("PythonMapper_operator.Generated.cs"), EXPECTED_OPERATOR)
            self.assertEquals(read("PythonMapper_numbers_convert_c2py.Generated.cs"), EXPECTED_NUMBERS_CONVERT_C2PY)
            self.assertEquals(read("PythonMapper_numbers_convert_py2c.Generated.cs"), EXPECTED_NUMBERS_CONVERT_PY2C)
            self.assertEquals(read("PythonMapper_fill_types.Generated.cs"), EXPECTED_FILL_TYPES)
...
USINGS = """\
/* This file was generated by tools/generatepythonmapper.py */
using System;
