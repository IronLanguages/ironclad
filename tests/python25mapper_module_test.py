...
class Python25Mapper_PyModule_AddObject_PropertiesTest(TestCase):
    ...
    def assertGetSet(self, mapper, attr, get, set, TestType, closure=IntPtr.Zero):
        ...
        self.assertEquals(module.klass.boing.__doc__, doc, "bad docstring")
...
class Python25Mapper_PyModule_AddObject_MembersTest(TestCase):
    
    def assertMember(self, mapper, attr, _type, offset, flags, TestModule, basicsize=32):
        modulePtr = MakeAndAddEmptyModule(mapper)
        module = ModuleWrapper(mapper.Engine, mapper.Retrieve(modulePtr))
        ...
        self.assertEquals(module.klass.boing.__doc__, doc, "wrong docstring")
        TestModule(module)
        deallocType()
    ...
    def testReadOnlyMember(self):
        ...
        def TestModule(module):
            ...
            def Get(address):
                ...
                return 12345
            module._dispatcher.get_member_int = Get
        ...
        self.assertMember(mapper, 'boing', MemberT.INT, offset, 1, TestModule)
        mapper.Dispose()
        deallocTypes()
    ...
    def testReadWriteIntMember(self):
        ...
        def TestModule(module):
            ...
            module._dispatcher.get_member_int = Get
            module._dispatcher.set_member_int = Set
        ...
        self.assertMember(mapper, 'boing', MemberT.INT, offset, 0, TestModule)
        mapper.Dispose()
        deallocTypes()
    ...
    def testReadWriteObjectMember(self):
        ...
        def TestModule(module):
            ...
            def Set(address, value):
                calls.append(('Set', (address, value)))
            module._dispatcher.get_member_object = Get
            module._dispatcher.set_member_object = Set
        ...
        self.assertMember(mapper, 'boing', MemberT.OBJECT, offset, 0, TestModule)
        mapper.Dispose()
        deallocTypes()
...
suite = makesuite(
    ...
    Python25Mapper_PyModule_AddObject_DispatchTrickyMethodsTest, # <- testDeleteResurrect breaks properties test and members test
    Python25Mapper_PyModule_AddObject_PropertiesTest,
    Python25Mapper_PyModule_AddObject_MembersTest,
)
