...
class Python25ApiFunctionsTest(TestCase):
    ...
    def testPython25ApiFindsMethods(self):
        ...
        self.assertFinds("PyObject_HasAttr", ('IntPtr(111)', 'IntPtr(222)'), '999')
        ...
        self.assertFinds("PyObject_SetItem", ('IntPtr(111)', 'IntPtr(222)', 'IntPtr(333)'), '123')
        ...
        self.assertFinds("PyObject_IsInstance", ('IntPtr(111)', 'IntPtr(222)'), '-123')
        self.assertFinds("PyObject_Size", ('IntPtr(111)',), '123')
        self.assertFinds("PyObject_Str", ('IntPtr(111)',), 'IntPtr(999)')
        self.assertFinds("PyObject_Repr", ('IntPtr(111)',), 'IntPtr(999)')
        ...
        self.assertFinds("PyObject_Realloc", ('IntPtr(111)', '222',), 'IntPtr(999)')
        ...
        self.assertFinds("PySequence_SetItem", ('IntPtr(111)', '123', 'IntPtr(222)'), '123')
        ...
        self.assertFinds("PyString_Repr", ('IntPtr(98765)', '4321'), 'IntPtr(12345)')
        ...
        self.assertFinds("PyLong_FromLong", ('1555555555',), 'IntPtr(999)')
