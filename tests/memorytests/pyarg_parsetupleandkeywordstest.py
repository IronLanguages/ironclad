...
class PyArg_ParseTupleAndKeywordsTest(unittest.TestCase):
    ...
    def assertMatchesVargargs(self, params):
        self.assertEquals(params[:4], (IntPtr(1), IntPtr(2), self.formatString, IntPtr(3)),
    ...
    def assertMarshalsVarargs(self, prefix, varargs, suffix):
        ...
        result = testFunc(IntPtr(1), IntPtr(2), self.formatString, IntPtr(3), *varargs)
    ...
    def test2Args(self):
        self.assertMarshalsVarargs("", (IntPtr(100), IntPtr(200)), ":foo")
