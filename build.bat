...
gcc -o tests/data/setvalue.o -c tests/data/source/setvalue.c
gcc -shared -o tests/data/setvalue.pyd tests/data/setvalue.o
gcc -o tests/data/exportsymbols.o -c tests/data/source/exportsymbols.c
gcc -shared -o tests/data/exportsymbols.dll tests/data/exportsymbols.o
csc /out:tests\data\jumpytestutils.dll /t:library /nologo tests\data\source\PythonStubHarness.cs
